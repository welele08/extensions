...
func (c *RepoCleaner) LoadTrees(treePath []string) error {
...
func (c *RepoCleaner) checkFilesWithTrees() error {
...
func (c *RepoCleaner) getFilteredList(files []string) ([]string, error) {
	ans := []string{}
